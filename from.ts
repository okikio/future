...
import { isPromiseLike, isAsyncIterator, isIterator, isAsyncIterable, isIterable, isBuiltinIterable, isAsyncGenerator, isGenerator } from "./_utils.ts";
 ...
 * 
 */
export function from<T, TReturn = T, TNext = unknown>(operation: PromiseLike<T>): ReturnType<typeof fromPromise<T>>;
export function from<T, TReturn = T, TNext = unknown>(operation: ReadableStream<T>): ReturnType<typeof fromStream<T>>;
export function from<T, TReturn = T, TNext = unknown>(operation: AsyncIterable<T> | Iterable<T | PromiseLike<T>>): ReturnType<typeof fromIterable<T, TReturn>>;
export function from<T, TReturn = T, TNext = unknown>(operation: Iterable<T | PromiseLike<T>>): ReturnType<typeof fromBuiltinIterable<T>>;
export function from<T, TReturn = T, TNext = unknown>(operation: AsyncIterator<T, TReturn, TNext> | Iterator<T | PromiseLike<T>, TReturn | PromiseLike<TReturn>, TNext>): ReturnType<typeof fromIterator<T, TReturn>>;
export function from<T, TReturn = T, TNext = unknown>(operation: FutureFromOperation<T, TReturn, TNext>): ReturnType<typeof fromOperation<T, TReturn, TNext>>;
export function from<T, TReturn = T, TNext = unknown>(operation: Future<T, TReturn, TNext>): Future<T, TReturn, TNext>;
export function from<T, TReturn = T, TNext = unknown>(operation: T): ReturnType<typeof of<T>>;
...
export function fromIterable<T, TReturn = T>(iterable: AsyncIterable<T> | Iterable<T | PromiseLike<T>>): Future<T, TReturn> {
  return new Future<T, TReturn>(async function* () {
    return yield* iterable;
  });
}

export function fromBuiltinIterable<T>(iterable: Iterable<T | PromiseLike<T>>): Future<T, Iterable<T | PromiseLike<T>>> {
...
export function fromIterator<T, TReturn = T, TNext = unknown>(iterator: AsyncIterator<T, TReturn, TNext> | Iterator<T | PromiseLike<T>, TReturn | PromiseLike<TReturn>, TNext>): Future<T, TReturn> {
